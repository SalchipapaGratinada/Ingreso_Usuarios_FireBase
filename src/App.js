    ...
    <div className="container">
      <div className="row">
        <div className="col-12">
          <h2 className="text-center">{modoEdicion ? 'Edicion De Usuario-FIREBASE':'Registro De Usuarios-FIREBASE'}</h2>
      ...
      <div className="row">
        <div className="col-12">
          <br></br>
          <br></br>
          <h2 className="text-center">Lista De Usuarios Registrados-FIREBASE</h2>
